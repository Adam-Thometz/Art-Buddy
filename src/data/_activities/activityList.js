...
import { CONNECT_OBJECTS_WITH_EVENTS, COUNT, DRAW_A_PICTURE, EXTEND_PATTERNS, IDENTIFY_LETTERS, IDENTIFY_MORE_AND_LESS, IDENTIFY_QUANTITY, READ_LEFT_TO_RIGHT, SEQUENCE_STORY, SIGHT_WORDS, VOCAB_WORDS, WORD_FAMILIES, WRITE_SIMPLE_WORDS } from "data/goals/goals";
import { COLOR_THEORY_ICON, FREE_PAINT_ICON, JUMP_INTO_RHYTHM_ICON, MOOD_METER, NOISE_METER, SCORE_KEEPER, SEQUENCE_MAKER_ICON, TIME_KEEPER, WHATS_THAT_INSTRUMENT_ICON, WORD_TO_MUSIC_ICON } from "assets/menu/menu.assets";
