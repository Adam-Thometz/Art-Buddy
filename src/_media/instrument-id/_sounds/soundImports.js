...
import djembeMidLow from "./instruments/percussion/djembe/mid-low.mp3";
import djembeMidHigh from "./instruments/percussion/djembe/mid-high.mp3";
...
import triangleMid from "./instruments/percussion/triangle/mid.mp3";
import triangleMidLoud from "./instruments/percussion/triangle/mid-loud.mp3";
import triangleMidQuiet from "./instruments/percussion/triangle/mid-quiet.mp3";
...
import drumSetCowbell from "./instruments/percussion/drum-set/cowbell.mp3";
...
import congaSlap from "./instruments/percussion/conga/slap.mp3";
...
const tambourine = {
  ...
  vintage: tambourineVintage,
  performance: tambourinePerformance,
};
...
const triangle = {
  ...
  quiet: triangleQuiet,
  mid: triangleMid,
  midLoud: triangleMidLoud,
  midQuiet: triangleMidQuiet,
};
