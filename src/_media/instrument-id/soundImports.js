import { ROOT_URL, MP3 } from "_media/awsS3Root";
...
const SYNTH = `${ROOT_URL}/instrument-id/sounds/electronic/synth.${MP3}`;
...
const DJEMBE_HIGH = `${ROOT_URL}/instrument-id/sounds/percussion/djemba/high.${MP3}`;
const DJEMBE_LOW = `${ROOT_URL}/instrument-id/sounds/percussion/djemba/low.${MP3}`;
const DJEMBE_MEDIUM = `${ROOT_URL}/instrument-id/sounds/percussion/djemba/medium.${MP3}`;
const DJEMBE_MID_HIGH = `${ROOT_URL}/instrument-id/sounds/percussion/djemba/mid-high.${MP3}`;
const DJEMBE_MID_LOW = `${ROOT_URL}/instrument-id/sounds/percussion/djemba/mid-low.${MP3}`;
