...
describe("play function", () => {
  ...
  it("should play a scale for non-rhythmic instruments when on the learn page", () => {
  ...
  it("should play a beat for rhythmic instruments when on the learn page", () => {
  ...
  it("should play a scale for non-rhythmic instruments when in the listening skills test", () => {
  ...
  it("should play a beat for rhythmic instruments when in the listening skills test", () => {
