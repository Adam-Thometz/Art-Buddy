...
describe('Color Theory Routes', () => {
  ...
  it('renders the main play page', () => {
    render(<ColorTheoryRoutes />, { initialRoutes: [colorTheoryUrls.playMain] });
    expect(screen.getByText('COLOR THEORY: PLAY')).toBeInTheDocument();
  });
  
  it('renders different levels', () => {
    render(<ColorTheoryRoutes />, { initialRoutes: [`${colorTheoryUrls.playMain}/1`] });
    expect(screen.getByText('Play: Level 1A')).toBeInTheDocument();
    render(<ColorTheoryRoutes />, { initialRoutes: [`${colorTheoryUrls.playMain}/2`] });
    expect(screen.getByText('Play: Level 2A')).toBeInTheDocument();
    render(<ColorTheoryRoutes />, { initialRoutes: [`${colorTheoryUrls.playMain}/3`] });
